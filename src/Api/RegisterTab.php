    ...
    public static function discountTabContent()
    {
        ...
        <div id="discounts_product_data" class="panel woocommerce_options_panel hidden">
            <div class="options_group">
                <h1><?php
                    _e('There you can set discount for different users role.', 'advanced-discounts'); ?></h1>
                <p><?php
                    _e(
                        'Discount calculate in % and must be typed as an integer from 0 to 100. If the field is left blank, will be displayed the price that specified in the General tab',
                        'advanced-discounts'
                    ); ?></p>
                <?php
